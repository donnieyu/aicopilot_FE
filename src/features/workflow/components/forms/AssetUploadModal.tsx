...
import { BaseModal } from '../../../../components/BaseModal'; // [New] Import
        ...
        <BaseModal
            ...
            title={
                <div>
                    ...
                    <p className="text-xs text-slate-500 font-normal">Upload documents to auto-generate the process map.</p>
                </div>
            }
            icon={UploadCloud}
            maxWidth="max-w-lg"
